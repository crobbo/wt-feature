...
```bash
curl -fsSL https://raw.githubusercontent.com/xtian/wt-feature/main/install.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/xtian/wt-feature/main/uninstall.sh | bash
```
